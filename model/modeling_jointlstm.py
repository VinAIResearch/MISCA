...
class JointLSTM(nn.Module):
    def __init__(self, args, num_vocab, intent_label_lst, slot_label_lst, slot_hier):
        ...
        if args.intent_slot_attn_type == 'attention_flow':
            self.attn = AttentionFlow(args, args.decoder_hidden_dim, args.slot_decoder_size, args.intent_slot_attn_size, args.dropout_rate)
        elif args.intent_slot_attn_type == 'coattention':
    ...
    def forward(self, input_ids, char_ids, seq_lens, intent_label_ids, slot_labels_ids, slot_hier=None):
        ...
        if self.args.auxiliary_tasks or self.args.intent_slot_attn_type == 'coattention':
