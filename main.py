...
def main(args):
    ...
    collate = TextCollate(0, len(get_intent_labels(args)), hiers)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_charcnn", action="store_true", help="Whether to use CharCNN")
    parser.add_argument("--use_charlstm", action="store_true", help="Whether to use CharLSTM")
